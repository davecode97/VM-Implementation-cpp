...
ControlUnit::ControlUnit(int theFlag) 
{
	flag = theFlag;
}


int ControlUnit::getFlag() { return flag; }
void ControlUnit::setFlag(int theFlag) { flag = theFlag; }
...
void ControlUnit::execute(std::string decodedInstruction, int theOperand1, int theOperand2)
{
	...
	if (option == 2) 
	{
		...
		std::cout << this->status << " Instruction:: " << "SUB..." << endl; 
	...
	if (option == 3) 
	{
		...
		std::cout << this->status << " Instruction:: " << "MULT..." << endl; 
		std::cout << "MULTIPLAYING:: " << theOperand1 << " * " << theOperand2 << " = " 
		          << CPU::acc.getValue() << endl;
		std::cout << endl;
	}
	if (option == 4) 
	{
		...
		std::cout << this->status << " Instruction:: " << "DIV..." << endl; 
		std::cout << "DIVING:: " << theOperand1 << " / " << theOperand2 << " = " 
		          << CPU::acc.getValue() << endl;
		std::cout << endl;
	}
